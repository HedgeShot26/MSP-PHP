                ...
                <div class="container" style="border:10px solid #eeeeee; padding: 20px; border-radius:50px; box-shadow: 0 8px 18px rgba(8, 8, 8, 0.3); ">
                    ...
                    <div class="mb-5" style="border-radius: 30px;background-color: #07689F; color: white; text-transform: uppercase; font-weight: bold;">
                        <h3 class="mt-1 py-1">
                            ...
                            <a href="<?= base_url('sales/salesAdd') ?>" class="btn btn-danger btn-sm float-end me-1 fw-bold" style="border: 3px solid red; border-radius:30px; width:20%;">BACK</a>
                        </h3>
                    </div>

                    <form action="<?= base_url('Sales/insert_sales') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
